package simple;
public class _Local3TAOPeer extends i2jrt.TAOLocalObject implements Local3 {
  protected _Local3TAOPeer(long ptr) {
    super(ptr);
  }

  public native simple.StructWithObjref op3(simple.StructWithObjref p1, simple.StructWithObjrefHolder p2, simple.StructWithObjrefHolder p3);
