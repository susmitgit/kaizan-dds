package simple;
public class _TestInterf3Stub extends i2jrt.TAOObject implements TestInterf3 {
  protected _TestInterf3Stub(long ptr) {
    super(ptr);
  }

  public native void op3(simple.TestNestedStruct p1);
