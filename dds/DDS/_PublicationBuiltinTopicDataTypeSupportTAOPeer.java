package DDS;
public class _PublicationBuiltinTopicDataTypeSupportTAOPeer extends i2jrt.TAOLocalObject implements PublicationBuiltinTopicDataTypeSupport {
  protected _PublicationBuiltinTopicDataTypeSupportTAOPeer(long ptr) {
    super(ptr);
  }
