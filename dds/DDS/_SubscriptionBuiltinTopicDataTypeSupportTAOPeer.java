package DDS;
public class _SubscriptionBuiltinTopicDataTypeSupportTAOPeer extends i2jrt.TAOLocalObject implements SubscriptionBuiltinTopicDataTypeSupport {
  protected _SubscriptionBuiltinTopicDataTypeSupportTAOPeer(long ptr) {
    super(ptr);
  }
