package DDS;
public class _TopicBuiltinTopicDataTypeSupportTAOPeer extends i2jrt.TAOLocalObject implements TopicBuiltinTopicDataTypeSupport {
  protected _TopicBuiltinTopicDataTypeSupportTAOPeer(long ptr) {
    super(ptr);
  }
