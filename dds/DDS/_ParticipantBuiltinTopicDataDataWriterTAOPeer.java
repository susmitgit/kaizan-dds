package DDS;
public class _ParticipantBuiltinTopicDataDataWriterTAOPeer extends i2jrt.TAOLocalObject implements ParticipantBuiltinTopicDataDataWriter {
  protected _ParticipantBuiltinTopicDataDataWriterTAOPeer(long ptr) {
    super(ptr);
  }

  public native int register_instance(DDS.ParticipantBuiltinTopicData instance);

  public native int register_instance_w_timestamp(DDS.ParticipantBuiltinTopicData instance, DDS.Time_t timestamp);

  public native int unregister_instance(DDS.ParticipantBuiltinTopicData instance, int handle);

  public native int unregister_instance_w_timestamp(DDS.ParticipantBuiltinTopicData instance, int handle, DDS.Time_t timestamp);

  public native int write(DDS.ParticipantBuiltinTopicData instance_data, int handle);

  public native int write_w_timestamp(DDS.ParticipantBuiltinTopicData instance_data, int handle, DDS.Time_t source_timestamp);

  public native int dispose(DDS.ParticipantBuiltinTopicData instance_data, int instance_handle);

  public native int dispose_w_timestamp(DDS.ParticipantBuiltinTopicData instance_data, int instance_handle, DDS.Time_t source_timestamp);
