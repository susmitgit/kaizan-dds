package DDS;
public class _TopicBuiltinTopicDataDataWriterTAOPeer extends i2jrt.TAOLocalObject implements TopicBuiltinTopicDataDataWriter {
  protected _TopicBuiltinTopicDataDataWriterTAOPeer(long ptr) {
    super(ptr);
  }

  public native int register_instance(DDS.TopicBuiltinTopicData instance);

  public native int register_instance_w_timestamp(DDS.TopicBuiltinTopicData instance, DDS.Time_t timestamp);

  public native int unregister_instance(DDS.TopicBuiltinTopicData instance, int handle);

  public native int unregister_instance_w_timestamp(DDS.TopicBuiltinTopicData instance, int handle, DDS.Time_t timestamp);

  public native int write(DDS.TopicBuiltinTopicData instance_data, int handle);

  public native int write_w_timestamp(DDS.TopicBuiltinTopicData instance_data, int handle, DDS.Time_t source_timestamp);

  public native int dispose(DDS.TopicBuiltinTopicData instance_data, int instance_handle);

  public native int dispose_w_timestamp(DDS.TopicBuiltinTopicData instance_data, int instance_handle, DDS.Time_t source_timestamp);
