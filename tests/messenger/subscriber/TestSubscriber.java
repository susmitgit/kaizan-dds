...
public class TestSubscriber {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Starting DDS-NAS Subscriber");
        ...
        while (true) {
            ...
            if (matched.value.current_count == 0
                ...
                System.out.println("DDS-NAS Subscriber No Longer Matched");
                break;
            }
            else if (matched.value.current_count > 0 &&
                     !matched_pub) {
                System.out.println("DDS-NAS Subscriber Matched");
                System.out.println("MATCHED YESSSS      DDS-NAS Subscriber Matched");
                matched_pub = true;
            }
        ...
        System.out.println("DDS-NAS Subscriber Report Validity checked");
        listener.report_validity();

        ws.detach_condition(sc);

        System.out.println("Stoping DDS-NAS Subscriber");

        dp.delete_contained_entities();
        dpf.delete_participant(dp);
        TheServiceParticipant.shutdown();

        System.out.println("DDS-NAS Subscriber exiting");
    }
}
